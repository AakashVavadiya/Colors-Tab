package com.my.androidwithlucky;
...
import com.colourstab.androidwithlucky.R;
...
public class MainActivity extends AppCompatActivity {
	...
	private void _targetMover (final double _position) {
		...
		_Animator(target, "translationX", ColorTabUtil.getDip(getApplicationContext(), (int)(position)), 200);
		timer = new TimerTask() {
			@Override
			public void run() {
				runOnUiThread(new Runnable() {
	...
	private void _Non_Select_Tab_Mover (final View _view, final double _position) {
		...
		_Animator(_view, "translationX", ColorTabUtil.getDip(getApplicationContext(), (int)(position2)), 200);
	}
